...
public class FIDEXI_547_Employee_StepDefinitions {
    ...
    public void pos_manager_click_on_the_ımport_button() {

    }

    @Then("Pos Manager should be able to land on the Import a File page")
    public void pos_manager_should_be_able_to_land_on_the_ımport_a_file_page() {
